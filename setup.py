...
desc = """\
Veneration is a decoder for, and interface to the bulkdata, cache and
...
for path, dirs, files in os.walk("src"):
	if "__init__.py" in files:
		...
		p = ("veneration." + path[4:].replace("\\", ".")).strip(".")
...
setup(
	...
	url = "http://github.com/jdhirst/veneration-py3",
